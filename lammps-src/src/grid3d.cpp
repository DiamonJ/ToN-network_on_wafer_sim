                   ...
                   void *buf1, void *buf2, MPI_Datatype datatype)
{
  ...
  for (m = 0; m < nswap; m++) {
    ...
    if (swap[m].sendproc != me) {
      ...
      if (swap[m].npack) {
        WsePlanKspace::instance().message("grid_forward",swap[m].sendproc,
                                          nper*swap[m].npack,nbyte);
        MPI_Send(buf1,nper*swap[m].npack,datatype,
                   ...
                   void *buf1, void *vbuf2, MPI_Datatype datatype)
{
  ...
  for (m = 0; m < nsend; m++) {
    ...
    WsePlanKspace::instance().message("grid_forward",send[m].proc,
                                      nper*send[m].npack,nbyte);
                   ...
                   void *buf1, void *buf2, MPI_Datatype datatype)
{
  ...
  for (m = nswap-1; m >= 0; m--) {
    ...
    if (swap[m].recvproc != me) {
      ...
      if (swap[m].nunpack) {
        WsePlanKspace::instance().message("grid_reverse",swap[m].recvproc,
                                          nper*swap[m].nunpack,nbyte);
        MPI_Send(buf1,nper*swap[m].nunpack,datatype,
                   ...
                   void *buf1, void *vbuf2, MPI_Datatype datatype)
{
  ...
  for (m = 0; m < nrecv; m++) {
    ...
    WsePlanKspace::instance().message("grid_reverse",recv[m].proc,
                                      nper*recv[m].nunpack,nbyte);
